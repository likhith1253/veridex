# Veridex — 5-Minute Razorpay Track 04 Pitch & Demo Guide
...
> 
> *Veridex is an autonomous, auditable AI Financial Control & Reconciliation Engine built for Razorpay Track 4 that closes this entire finance ops loop across multi-source streams with measured accuracy, sub-millisecond throughput, and an honest, auditable exception list."*
...
3. **Closing Statement**:
   > *"Veridex demonstrates high throughput ($>1,800\text{ tps}$), measured 94.66% F1 accuracy, transparent financial risk exposure, and grounded AI operations. It is fully validated and ready for Razorpay Track 4."*
